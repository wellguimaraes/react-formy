...
exports.useFormy = exports.setErrorPropName = void 0;
...
var getFieldOnChange = memoizee_1.default(function (fieldPath, touched, setTouched, onFieldChange, onChange) { return function (e) {
    var _a;
    if (!touched[fieldPath]) {
        setTouched(__assign(__assign({}, touched), (_a = {}, _a[fieldPath] = true, _a)));
    }
...
function useFormy(_a) {
    ...
    var runValidationRef = react_1.useRef(debounce_1.default(function (values) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var field = react_1.useCallback(function (fieldPath, _a) {
        ...
        if (defaultValue !== undefined &&
            ...
            setInitialValues(__assign(__assign({}, defaultValues), (_b = {}, _b[fieldPath] = defaultValue, _b)));
            if (!touched[fieldPath]) {
        ...
        var fieldProps = (_c = {
                ...
                get value() {
                    var currentValue = getFieldValue(fieldPath);
        ...
        Object.defineProperty(fieldProps, 'unshift', {
            value: function (v) {
                onFieldChange(fieldPath, __spreadArrays([
                    v
        ...
        Object.defineProperty(fieldProps, 'push', {
            value: function (v) {
                onFieldChange(fieldPath, __spreadArrays((getFieldValue(fieldPath) || []), [
                    v
                ]));
            }
        });
    ...
    var handleSubmit = react_1.useCallback(function (onSubmit) { return function (e) {
        ...
        onSubmit === null || onSubmit === void 0 ? void 0 : onSubmit(getValues());
    }; }, []);
    ...
    var setFormValues = react_1.useCallback(function (newValues) {
        setValues(__assign(__assign({}, getValues()), newValues));
    }, []);
